  ...
  return (
    <div className="-mx-6 -my-10 lg:-mx-8">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-primary-50 via-white to-white py-24">
        ...
        <div className="relative mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-12 px-6 lg:grid-cols-2 lg:px-8">
          ...
          <div className="flex flex-col gap-6">
            <span className="inline-flex w-fit items-center rounded-full border border-primary-200 bg-primary-50 px-3 py-1 text-[12px] font-semibold text-primary-700">
              Now in early access
            </span>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/#how-it-works"
                className="shrink-0 text-[12px] text-primary-500 no-underline hover:underline">
                See how it works ↓
              </Link>
            </div>
          </div>

          {/* Right — booking card mock */}
          <div className="flex items-center justify-center">
            <div className="w-full max-w-sm rounded-2xl border border-neutral-100 bg-white p-5 shadow-card">
              <div className="flex items-start gap-3">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-primary-100 text-[15px] font-bold text-primary-700">
                  AK
                </div>
                <div>
                  <p className="text-[14px] font-semibold text-neutral-900">Anya Kowalski</p>
                  <p className="text-[12px] text-neutral-500">Senior PM @ Stripe · 8 yrs</p>
                  <div className="mt-1.5 flex flex-wrap gap-1">
                    {["Product", "Fintech", "Career growth"].map((t) => (
              ...
              <div className="mb-3 flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[11px] text-neutral-400">· 24 sessions</span>
                </div>
              ...
              {[
                { day: "Mon", time: "9:00 – 9:30 AM" },
                { day: "Wed", time: "6:00 – 6:30 PM" },
                { day: "Fri", time: "12:00 – 12:30 PM" },
              ].map((s) => (
                <div key={s.day}
                  className="mb-1.5 flex items-center justify-between rounded-lg border border-neutral-100 bg-neutral-50 px-3 py-2">
                  <span className="text-[12px] text-neutral-700">{s.day} · {s.time}</span>
                  <span className="text-[10px] font-medium text-emerald-600">Open</span>
                </div>
              ))}

              <button className="mt-3 w-full rounded-xl bg-primary-600 py-2.5 text-[13px] font-semibold text-white hover:bg-primary-700">
                Request a session →
              </button>
            </div>
          </div>
      ...
      <section className="border-y border-neutral-100 bg-neutral-50 py-6">
        <div className="mx-auto flex w-full max-w-6xl flex-wrap items-center justify-center gap-x-12 gap-y-3 px-6 lg:px-8">
          {[
            "200+ sessions booked",
            "4.9 / 5 avg rating",
            "50+ active Aurors",
            "Software · PM · Hardware",
          ].map((s) => (
            <span key={s} className="flex items-center gap-2 text-[13px] font-medium text-neutral-500">
      ...
      <Section id="how-it-works" className="bg-white">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <div aria-hidden className="absolute left-0 right-0 top-[28px] hidden h-px bg-neutral-100 lg:block" style={{ left: "calc(16.67% + 28px)", right: "calc(16.67% + 28px)" }} />
        ...
        <div className="mt-10 flex justify-center">
          <Link href="/signup"
            className="inline-flex h-10 items-center rounded-xl bg-primary-600 px-6 text-[13px] font-semibold text-white no-underline hover:bg-primary-700">
            Start onboarding →
          </Link>
        </div>
      </Section>
          ...
          <div className="flex flex-col items-center gap-5 rounded-2xl border border-neutral-200 bg-white p-8 text-center shadow-soft">
            <div className="flex h-14 w-14 items-center justify-center rounded-full border border-amber-200 bg-amber-50">
              <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M11 14C8.5 11.5 4.5 11 2 12.5C4 13.5 6 15.5 7.5 17C9 15.5 10 14.5 11 14Z"
                  fill="#F59E0B" fillOpacity="0.25" stroke="#D97706" strokeWidth="1" strokeLinejoin="round"/>
                <path d="M17 14C19.5 11.5 23.5 11 26 12.5C24 13.5 22 15.5 20.5 17C19 15.5 18 14.5 17 14Z"
                  fill="#F59E0B" fillOpacity="0.25" stroke="#D97706" strokeWidth="1" strokeLinejoin="round"/>
            ...
            <Link href="/signup"
              className="mt-auto inline-flex h-9 w-full items-center justify-center rounded-xl border border-amber-200 bg-amber-50 text-[13px] font-semibold text-amber-700 no-underline hover:bg-amber-100">
              Join as a Seeker
            </Link>
          </div>
          ...
          <div className="flex flex-col items-center gap-5 rounded-2xl border border-neutral-200 bg-white p-8 text-center shadow-soft">
            <div className="flex h-14 w-14 items-center justify-center rounded-full border border-primary-200 bg-primary-50">
              <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M14 8L19.5 10.5V15.5C19.5 18.5 14 21 14 21C14 21 8.5 18.5 8.5 15.5V10.5L14 8Z"
                  fill="#EFF6FF" stroke="#2563EB" strokeWidth="1.4" strokeLinejoin="round"/>
            ...
            <Link href="/signup"
              className="mt-auto inline-flex h-9 w-full items-center justify-center rounded-xl bg-primary-600 text-[13px] font-semibold text-white no-underline hover:bg-primary-700">
              Join as an Auror
            </Link>
          </div>
        </div>
      ...
      {/* ── 6. Profiles that actually matter ──────────────────────────────── */}
      <Section className="bg-neutral-50">
              ...
              {[
                {
                  ...
                  detail: "Structured work history with roles, companies, and timelines — auto-calculated total experience.",
                },
                {
                  label: "Skills & tracks",
                  detail: "Primary and secondary tracks, skills, and domain tags — built for smart filtering.",
                },
                {
                  label: "Session types",
                  detail: "Know upfront whether an Auror offers Coffee Chats, Mock Interviews, or both.",
                },
                {
                  label: "Ratings & reviews",
                  detail: "Star ratings and written reviews from real sessions. Visible to all, anonymous by default.",
                },
              ].map((item) => (
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-sm rounded-2xl border border-neutral-100 bg-white p-5 shadow-card">
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-1">
                  {["figma", "product strategy", "roadmapping", "fintech"].map((s) => (
                    <span key={s} className="rounded-md border border-neutral-100 bg-neutral-50 px-2 py-0.5 text-[11px] text-neutral-600">
                      {s}
                    </span>
                  ))}
                </div>
              ...
              <div className="flex gap-2 border-t border-neutral-100 pt-3">
                <span className="rounded-full border border-primary-100 bg-primary-50 px-2.5 py-1 text-[11px] font-medium text-primary-700">
                  ☕ Coffee Chat
                </span>
                <span className="rounded-full border border-primary-100 bg-primary-50 px-2.5 py-1 text-[11px] font-medium text-primary-700">
                  🎯 Mock Interview
      ...
      <Section id="features" className="bg-white">
        <div className="mb-12 text-center">
          ...
          <h2 className="text-3xl font-bold text-neutral-900">
            Built around the session lifecycle
          </h2>
          <p className="mx-auto mt-3 max-w-lg text-[14px] text-neutral-500">
            Every feature is designed to make sessions more valuable — from
            discovery to takeaways.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <FeatureCard
            icon={
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                ...
                <path d="M6 3V5M12 3V5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                <path d="M5.5 11l2 2 4-3.5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            }
          ...
          <FeatureCard
            icon={
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                <path d="M3 4h12M3 8h8M3 12h5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                <circle cx="14" cy="12" r="3" stroke="currentColor" strokeWidth="1.4"/>
                <path d="M13 12l.8.8 1.7-1.6" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            }
            title="Key takeaways"
          ...
          <FeatureCard
            icon={
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                <path d="M9 2l1.8 3.6L15 6.3l-3 2.9.7 4.1L9 11.4l-3.7 1.9.7-4.1-3-2.9 4.2-.7L9 2z"
